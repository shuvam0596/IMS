...
$query = mysqli_query($link,"insert into location(location_name) values ('$location_name')");
 ...
 ?>
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-files-o"></i> New Location</h3>
                ...
                <div class="form">
                  <form class="form-validate form-horizontal" id="register_form" method="post" action="">
                    <div class="form-group ">
                      <label for="fullname" class="control-label col-lg-2">Location <span class="required">*</span></label>
                      <div class="col-lg-10">
                        <input class=" form-control" id="location_name" required name="location_name" type="text" />
                      </div>
                    </div>
...
?>
<tr> <td><?php echo $i;?></td>
<td>  <?php echo $nt['location_name'] ?></td></tr>
